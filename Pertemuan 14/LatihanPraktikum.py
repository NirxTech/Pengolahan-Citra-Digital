...
# Build CNN menggunakan Functional API agar kompatibel dengan Keras 3
    def build_cnn_model(input_shape=(32, 32, 3), num_classes=10):
        # 1. Definisikan Input secara eksplisit
        ...
        # Gabungkan Input dan Output menjadi Model
    ...
    for layer_name, layer_activation in zip(layer_names, activations):
        if 'conv' in layer_name:
            ...
            fig, axes = plt.subplots(n_rows, n_cols, figsize=(n_cols*2, max(2, n_rows*2)))
...
def praktikum_transfer_learning():
    ...
    eps = 1e-7
    test_f1_aug = 2 * (test_prec_aug * test_rec_aug) / (test_prec_aug + test_rec_aug + eps)
